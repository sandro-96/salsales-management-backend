...
public class GlobalExceptionHandler {
    ...
    private HttpStatus getHttpStatus(ApiCode errorCode) {
        return switch (errorCode) {
            ...
            case SUBSCRIPTION_EXPIRED -> HttpStatus.PAYMENT_REQUIRED;
            case VALIDATION_ERROR, INVALID_TOKEN, ACCOUNT_LOCKED, REFRESH_TOKEN_EXPIRED,
                    ...
                    CUSTOMER_PHONE_DUPLICATE, CUSTOMER_EMAIL_DUPLICATE,
                    LEAVE_REQUEST_INVALID_STATUS, LEAVE_REQUEST_OVERLAP,
