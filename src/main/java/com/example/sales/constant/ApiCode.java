...
public enum ApiCode {
    ...
    CATALOG_OFF_BROWSE_OK("2024", "Open Food Facts browse completed"),
    CATALOG_BULK_IMPORTED("2025", "Catalog bulk import completed"),
    OFF_UNAVAILABLE("4186", "Could not reach Open Food Facts"),
